---
title: "AI & Explainable AI for Spectroscopic and Chemical Mapping Data"
...
ggplot(events, aes(x = year, y = 0)) +
  ...
  geom_label(aes(y = side * 0.62, label = event),
...
# Part II — Dimension Reduction {background-color="#2196F3"}
...
# 🔬 Case Study 1 — Honey FTIR {background-color="#FF9800"}
...
# Part III — Clustering {background-color="#4CAF50"}
...
# 🔬 Case Study 2 — OPTIR Dentin / Enamel {background-color="#E91E63"}
...
ggplot(optir_load_long, aes(Wavenumber, Loading, colour = Component)) +
  ...
  ggrepel::geom_label_repel(
    data = all_peaks,
    aes(label = sprintf("%.0f cm⁻¹", Wavenumber)),
...
# Part IV — Building Models {background-color="#9C27B0"}
...
# 🔬 Case Study 3 — XRF Halobates Mapping {background-color="#00BCD4"}
...
# Part V — Explainable AI (XAI) {background-color="#FF5722"}
